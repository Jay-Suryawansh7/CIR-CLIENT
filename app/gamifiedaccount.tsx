...
export default function GamifiedAccount() {
  const { user } = useUser();
  ...
  return (
    // ✅ Apply same ClerkProvider styling as layout.tsx
    <ClerkProvider
      appearance={{
        variables: {
          colorPrimary: "#111827",
      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" onClick={() => (window.location.href = FEED_URL)}>
              <Settings className="h-4 w-4 mr-1" />
              Feed
            </Button>

            {/* ✅ Native Clerk SignOutButton */}
            <SignOutButton >
